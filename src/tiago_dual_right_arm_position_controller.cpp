...
namespace tiago_dual_right_arm_position_controller_ns
 {
   ...
   PLUGINLIB_EXPORT_CLASS(tiago_dual_right_arm_position_controller_ns::JointPositionController, controller_interface::ControllerBase);
 } 
